package org.greeneyed.skyscannerf.model;
...
public class Airport implements Comparable<Airport> {
    ...
    private final boolean includingIataFaaCode;
    ...
    public Airport(String line) {
        ...
        // Field 4 - IATA/FAA
        // 3-letter FAA code, for airports located in Country "United States of
        // America".
        // 3-letter IATA code, for all other airports. Blank if not assigned.
        // Field 5 - ICAO 4-letter ICAO code. Blank if not assigned.
        // Field 6 - Latitude Decimal degrees, usually to six significant
        // digits. Negative is South, positive is North.
        // Field 7 - Longitude Decimal degrees, usually to six significant
        // digits. Negative is West, positive is East.
        // Field 8 - Altitude In feet.
        // Field 9 - Timezone Hours offset from UTC. Fractional hours are
        // expressed as decimals, eg. India is 5.5.
        // Field 10 - DST Daylight savings time. One of E (Europe), A
        // (US/Canada), S (South America), O (Australia), Z (New Zealand), N
        // (None) or U
        // (Unknown).
        // Field 11 - See also: Help: Time
        // Field 12 - Tz database time zone Timezone in "tz" (Olson) format, eg.
        // "America/Los_Angeles".
        ...
        includingIataFaaCode = StringUtils.isNotBlank(iataFaaCode);
